# wizard-notes.com/entry/python/mutagen-cheatsheet
...
for file in files:
    ...
    if extension == 'mp3' or extension == 'mp4' or extension == 'm4a' or extension == 'flac':
        print(file)
...
for file in checked_files:
    ...
    print(values)
    cur.execute(
        'INSERT INTO music_metadata(title, album, artist, album_artist, track_number, album_number, length, path) VALUES ' + values
    )
